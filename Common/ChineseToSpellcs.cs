...
namespace Common
{
    ...
    {
        IChineseConverter _chineseConverter;
        //public ConverterClass(IChineseConverter chinese) : this(chinese)
        //{             
        //}

        public ConverterClass(IChineseConverter chinese)
        {
            _chineseConverter = chinese;
        }

        public string Get(string str)
        {
            return _chineseConverter.Get(str);
        }
    }
...
"zi","zong","zou","zu","zuan","zui","zun","zuo"};
    ...
    /// 包含二级汉子
    /// </summary>
    public class PinYinConverter : IChineseConverter
    {
        #region 数组信息
