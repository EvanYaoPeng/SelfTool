...
{
public class PopLvyouDujiaProductAddRequest : IJdRequest<PopLvyouDujiaProductAddResponse>
{
...
public   		string
   priceListJson  { get; set; }
		...
		public IDictionary<string, string> GetParameters()
        {
			...
			parameters.Add("pictureUrlListJson", this.pictureUrlListJson);
