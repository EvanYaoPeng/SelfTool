(function (a,
 b) {
    ...
    d) {
        ...
        e) {
            c || bD.test(a) ? d(a,
            e) : b_(a + "[" + (typeof e == "object" ? b : "") + "]",
            e,
            c,
            d) }
       );
        else if (!c && f.type(b) === "object") for (var e in b) b_(a + "[" + e + "]",
        b[e],
        c,
        d);
        else d(a,
    ...
    c) {
        ...
        if (d > 0) {
            if (c !== "border") for (;
            e < g;
            e += 2) c || (d -= parseFloat(f.css(a,
            "padding" + bx[e])) || 0),
            c === "margin" ? d += parseFloat(f.css(a,
            c + bx[e])) || 0 : d -= parseFloat(f.css(a,
            "border" + bx[e] + "Width")) || 0;
            return d + "px" }
        d = by(a,
        b);
           ...
           ,
                bindReady: function () {
                    if (!A) {
                        ...
                        if (c.readyState === "complete") return setTimeout(e.ready,
                        1);
                        if (c.addEventListener) c.addEventListener("DOMContentLoaded",
                        B,
                        !1),
...
(),
 g = {
    ...
    ,
        when: function (a) {
            ...
            if (d > 1) {
                for (;
                c < d;
                c++) b[c] && b[c].promise && f.isFunction(b[c].promise) ? b[c].promise().then(l(c),
                j.reject,
                m(c)) : --g;
                g || j.resolveWith(j,
                b) }
    ...
    f.support = function () {
       ...
       ,
        ...
        f(function () {
            ...
            p.style.width = "2px",
            p.appendChild(l),
            b.reliableMarginRight = (parseInt((a.getComputedStyle(l,
            null) || {
                marginRight: 0 }
           ).marginRight,
            10) || 0) === 0),
           ...
           ,
            ...
            b.pixelMargin = (a.getComputedStyle(p,
            null) || {
                marginTop: 0 }
           ).marginTop !== "1%"),
    ...
    ,
        ...
        e) {
            if (!!f.acceptData(a)) {
               ...
               ,
                l || (m[n].toJSON = f.noop));
                if (typeof c == "object" || typeof c == "function") e ? m[n] = f.extend(m[n],
    ...
    f.fn.extend({
        ...
        c) {
            ...
            function (c) {
                ...
                this.each(function () {
                    var b = f(this);
                    b.triggerHandler("setData" + e,
                    d),
                    f.data(this,
                    a,
                    c),
                    b.triggerHandler("changeData" + e,
                    d) }
               ) }
           ,
            null,
    ...
    f.fn.extend({
        ...
        c) {
            ...
            a = "fx",
            d--);
            if (arguments.length < d) return f.queue(this[0],
            a);
            return c === b ? this : this.each(function () {
                var b = f.queue(this,
                a,
                c);
                a === "fx" && b[0] !== "inprogress" && f.dequeue(this,
                a) }
           ) }
    ,
        dequeue: function (a) {
    ...
    ,
        ...
        e) {
            ...
            if (!!a && j !== 3 && j !== 8 && j !== 2) {
                ...
                if (typeof a.getAttribute == "undefined") return f.prop(a,
                c,
                d);
                i = j !== 1 || !f.isXMLDoc(a),
                i && (c = c.toLowerCase(),
    ...
    ,
        ...
        g) {
            if (!e || e.nodeType !== 3 && e.nodeType !== 8) {
                ...
                "a")) && f.acceptData(e) && o && e[h] && (h !== "focus" && h !== "blur" || c.target.offsetWidth !== 0) && !f.isWindow(e) && (n = e[o],
                n && (e[o] = null),
                f.event.triggered = h,
                e[h](),
                f.event.triggered = b,
    ...
    f.support.submitBubbles || (f.event.special.submit = {
        setup: function () {
            ...
            function (a) {
                ...
                "input") || f.nodeName(c,
                "button") ? c.form : b;
                d && !d._submit_attached && (f.event.add(d,
                "submit._submit",
                function (a) {
                    a._submit_bubble = !0 }
               ),
    ...
    ,
        ...
        d) {
            if (a && a.preventDefault && a.handleObj) {
                var e = a.handleObj;
                f(a.delegateTarget).off(e.namespace ? e.origType + "." + e.namespace : e.origType,
                e.selector,
                e.handler);
                return this }
            if (typeof a == "object") {
    ...
    function () {
        ...
        f) {
            ...
            while (i);
            if (w.length > 1 && p.exec(b)) if (w.length === 2 && o.relative[w[0]]) j = y(w[0] + w[1],
            d,
            f);
            else {
            ...
            k[t] != null;
            t++) k[t] && (k[t] === !0 || k[t].nodeType === 1 && m.contains(d,
            k[t])) && e.push(j[t]);
            else for (t = 0;
            k[t] != null;
       ...
       ,
        ...
        function () {
            ...
            e.insertBefore(a,
            e.firstChild),
            c.getElementById(d) && (o.find.ID = function (a,
            c,
            d) {
 ...
 R = {
   ...
   ,
        ...
        b) {
            ...
            b) : f.makeArray(a && a.nodeType ? [a] : a),
            d = f.merge(this.get(),
            c);
   ...
   ,
    ...
    bg.th = bg.td,
    f.support.htmlSerialize || (bg._default = [1,
    "div<div>",
    "</div>"]),
    f.fn.extend({
 ...
 function (a) {
        ...
        html: function (a) {
            ...
            function (a) {
               ...
               ,
                d = 0,
                e = this.length;
                if (a === b) return c.nodeType === 1 ? c.innerHTML.replace(W,
                "") : null;
            ...
            k++) {
                ...
                if (typeof l == "string") if (!_.test(l)) l = b.createTextNode(l);
                    ...
                    if (!f.support.tbody) {
                        ...
                        i >= 0;
                        --i) f.nodeName(t[i],
                        "tbody") && !t[i].childNodes.length && t[i].parentNode.removeChild(t[i]) }
                ...
                l.nodeType ? j.push(l) : j = f.merge(j,
                l) }
            if (d) {
                g = function (a) {
                ...
                k++) {
                    h = j[k];
                    if (e && f.nodeName(h,
                    "script") && (!h.type || be.test(h.type))) e.push(h.parentNode ? h.parentNode.removeChild(h) : h);
                    else {
                        if (h.nodeType === 1) {
                            var v = f.grep(h.getElementsByTagName("script"),
                            g);
                            j.splice.apply(j,
                            [k + 1,
                            0].concat(v)) }
        ...
        e) {
            if (!!a && a.nodeType !== 3 && a.nodeType !== 8 && !!a.style) {
                ...
                if (d === b) {
                    ...
                    return j[c] }
                h = typeof d,
                h === "string" && (g = bu.exec(d)) && (d = +(g[1] + 1) * +g[2] + parseFloat(f.css(a,
                c)),
                h = "number");
                if (d == null || h === "number" && isNaN(d)) return;
                h === "number" && !f.cssNumber[i] && (d += "px");
                if (!k || !("set" in k) || (d = k.set(a,
                d)) !== b) try {
                    j[c] = d }
                catch (l) {
                }
   ...
   ,
    ...
    f.curCSS = f.css,
    c.defaultView && c.defaultView.getComputedStyle && (bz = function (a,
    b) {
        var c,
        d,
        e,
    ...
    c.documentElement.currentStyle && (bA = function (a,
    b) {
        var c,
        d,
        e,
   ...
   ,
        ...
        b) {
            ...
            c.filter = bp.test(g) ? g.replace(bp,
            e) : g + " " + e }
    }
   ),
    f(function () {
        f.support.reliableMarginRight || (f.cssHooks.marginRight = {
            ...
            b) {
               ...
               ,
                function () {
                    return b ? by(a,
                    "margin-right") : a.style.marginRight }
               ) }
        }
       ) }
   ),
   ...
   ,
    ...
    f.fn.extend({
        ...
        c,
        d) {
            if (typeof a != "string" && bR) return bR.apply(this,
            arguments);
            ...
            f.ajax({
                ...
                c) {
                    ...
                    i.html(g ? f("<div>").append(c.replace(bM,
                    "")).find(g) : c)),
                    d && i.each(d,
                    [c,
                    b,
...
,
        ...
        c) {
           ...
           ,
            ...
            f.lastModified[k]),
            f.etag[k] && v.setRequestHeader("If-None-Match",
            f.etag[k])),
...
,
    ...
    d) {
        ...
        if (b.dataTypes[0] === "jsonp" || b.jsonp !== !1 && (cd.test(b.url) || e && cd.test(b.data))) {
            ...
            k = b.data,
            l = "$1" + h + "$2";
            b.jsonp !== !1 && (j = j.replace(cd,
            l),
            b.url === j && (e && (k = k.replace(cd,
            l)),
    ...
    f.fn.extend({
        ...
        c) {
            var d,
            e;
            if (a || a === 0) return this.animate(ct("show",
            3),
            a,
            b,
            c);
            ...
            (e === "" && f.css(d,
            "display") === "none" || !f.contains(d.ownerDocument.documentElement,
            d)) && f._data(d,
            "olddisplay",
            cu(d.nodeName)));
            for (g = 0;
            ...
            g++) {
                ...
                if (d.style) {
                    e = d.style.display;
                    if (e === "" || e === "none") d.style.display = f._data(d,
                    "olddisplay") || "" }
            }
            return this }
    ,
        ...
        b,
        c) {
            if (a || a === 0) return this.animate(ct("hide",
            3),
            a,
            b,
            c);
    ...
    ,
        ...
        d) {
            function g() {
               ...
               ,
                ...
                for (g in a) {
                    ...
                    "float") === "none" && (!f.support.inlineBlockNeedsLayout || cu(this.nodeName) === "inline" ? this.style.display = "inline-block" : this.style.zoom = 1)) }
                b.overflow != null && (this.style.overflow = "hidden");
                for (i in a) j = new f.fx(this,
                b,
                i),
                h = a[i],
                cm.test(h) ? (q = f._data(this,
           ...
           ,
            a);
            return e.queue === !1 ? this.each(g) : this.queue(e.queue,
            g) }
    ,
        stop: function (a,
        c,
        d) {
            ...
            return this.each(function () {
                ...
                d || f._unmark(!0,
                this);
                if (a == null) for (b in g) g[b] && g[b].stop && b.indexOf(".run") === b.length - 4 && h(this,
                g,
                b);
                else g[b = a + ".run"] && g[b].stop && h(this,
                g,
                b);
                for (b = e.length;
                b--;
    ...
    ,
        ...
        d) {
            ...
            h.saveState = function () {
                f._data(e.elem,
                "fxshow" + e.prop) === b && (e.options.hide ? f._data(e.elem,
                "fxshow" + e.prop,
                e.start) : e.options.show && f._data(e.elem,
                "fxshow" + e.prop,
                e.end)) }
           ,
    ...
    cw = /^t(?:able|d|h)$/i,
    cx = /^(?:body|html)$/i;
    "getBoundingClientRect" in c.documentElement ? cv = function (a,
    b,
    c,
    d) {
        try {
    ...
    c) {
        ...
        h = b.body,
        i = b.defaultView,
        j = i ? i.getComputedStyle(a,
        null) : a.currentStyle,
        k = a.offsetTop,
        l = a.offsetLeft;
        while ((a = a.parentNode) && a !== h && a !== c) {
            if (f.support.fixedPosition && j.position === "fixed") break;
            d = i ? i.getComputedStyle(a,
            null) : a.currentStyle,
            k -= a.scrollTop,
            l -= a.scrollLeft,
            a === e && (k += a.offsetTop,
        ...
        l += h.offsetLeft;
        f.support.fixedPosition && j.position === "fixed" && (k += Math.max(c.scrollTop,
        h.scrollTop),
        l += Math.max(c.scrollLeft,
        h.scrollLeft));
        return {
            top: k,
            left: l }
