...
namespace SelfTools
{
    public partial class Form1 : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            if (op.ShowDialog() == DialogResult.OK)
            {
                this.richTextBox1.Text = pdf.ExtractTextFromPDFPage(op.FileName, 1);
            }
            //@"C:\Users\renaw\Downloads\jb51.net\DotNetNuke 4 高级编程(jb51.net).pdf"
            //this.richTextBox1.Text = pdf.ReadPdfFile(@"C:\Users\renaw\Desktop\创建多个Pdf新页.pdf");
        }
        ...
        {
            this.richTextBox1.Text += PinYinConverter.Get(this.textBox1.Text);
        }

        private void button5_Click(object sender, EventArgs e)
        {
            this.richTextBox1.Text += ChineseToSpell.ConvertToAllSpell(this.textBox1.Text);
        }
        ...
        //{
        //    MSMQManagement mgmt = new MSMQManagement();
        ...
        string QueuePath = ".\\private$\\yuyue";
        ...
        public void Resv()
        {
            ...
            {
               // LogHelper.WriteApplicationLog("对不起,访问的队列不存在");
                throw new Exception("对不起,访问的队列不存在");
            }
        ...
        public void DoResv()
        {
            try
            {
                while (true)
                {
                    ...
                    {
                      //  LogHelper.WriteApplicationLog("批量预约的剩余消息：" + queue.GetAllMessages().Length);
                        var result = queue.Receive();//未执行成功的数据记录起来，最后可以查询返回给预约操作人
                        result.Formatter = new System.Messaging.XmlMessageFormatter(new Type[] { typeof(string) });
                      //  Resving(result.Label, result.Body.ToString());
                    }
                }
            }
            catch (Exception ex)
    ...
    {
        private static System.Text.RegularExpressions.Regex MyRegex = new System.Text.RegularExpressions.Regex("^[一-龥]$"); //汉字的正则表达式.eg: if(MyRegex.IsMatch(chrstr.ToString()))
...
"zi","zong","zou","zu","zuan","zui","zun","zuo"};
        ...
        {
            System.Text.RegularExpressions.Regex MyRegex = new System.Text.RegularExpressions.Regex("^[一-龥]$");
